...
\newcommand{\AFiveSize}{paperwidth=148mm,paperheight=210mm,left=0.875in,right=0.625in,top=0.825in,bottom=0.825in,twoside}
...
\newcommand{\USSmallTrade}{paperwidth=5.25in,paperheight=8.5in,left=0.875in,right=0.625in,top=0.825in,bottom=0.825in,twoside}
\newcommand{\Novella}{paperwidth=5in,paperheight=8in,left=0.875in,right=0.625in,top=0.825in,bottom=0.825in,twoside}
\newcommand{\MassMarket}{paperwidth=4.3in,paperheight=7in,left=0.775in,right=0.525in,top=0.825in,bottom=0.825in,twoside}
