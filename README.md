...
**Note:** Readme Auto-generated  (2019-12-30 16:04 UTC). Do not edit this file.
...
* **[Automated Book Formatting](./docs/features/automated-book-formatting.md).** Cycle your long-form narrative work product (um, book) faster and simplify your writing workflow that continuously delivers production-ready books.
* **[Git-Managed Content on Github](./docs/features/git-managed.md).** Keep your content in Github, the world's leading software development platform along with 100 million other projects.
* **[Write in Markdown](./docs/features/markdown.md).** Write in Markdown, a lightweight markup language, which lets you focus on your prose with minor styling. It is portable, platform-independent, future-proof, and used everywhere.
...
* Source Sans Pro
* Libre Baskerville
[Read more](./docs/configuration/fonts-available.md)
<!-- /fonts-available -->
