...
% \newcommand{\lo}{\MakeUppercase{$title$}} % Odd Page.
% \newcommand{\re}{\MakeUppercase{$author$}} % Even Page.
\fancyhead[CO]{ \headerfont \MakeUppercase{$title$} } % Even Page, Right side
\fancyhead[CE]{ \headerfont \MakeUppercase{$author$} } % Even Page, Right side
...
\pagenumbering{roman}
  ...
  % r.3 Titlepage - Recto
    ...
    \begin{center}
      ...
      \vspace*{0.125in}\Large\textbf{\textsf{$subtitle$}}$endif$
  ...
  \pagestyle{empty}
    ...
    $if(firstprint)$
      \newdate{firstprint}$for(firstprint)${$firstprint$}$endfor$
